...
import { Zap, Eye, CloudRain, Droplets, Gauge, Activity, RotateCcw, Info } from 'lucide-react';
...
export const RiskEnginePage: React.FC = () => {
  ...
  const simAIComponent = simAI / 100.0;
  const simRainComponent = Math.min(1.0, simRain / 60.0);
  const simSoilComponent = Math.min(1.0, simSoil / 100.0);
  const simMovementComponent = Math.min(1.0, simMovement / 15.0);
  const simPoreComponent = Math.min(1.0, simPore / 60.0);

  const rawSimScore =
    simAIComponent * 35 +
    simMovementComponent * 30 +
    simRainComponent * 15 +
    simSoilComponent * 10 +
    simPoreComponent * 10;
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-base font-bold text-text-primary uppercase tracking-wider font-display">
              FALCON Risk Engine &amp; Fusion Architecture
            </h1>
            <p className="text-xs font-mono text-text-muted">
              50/50 Dual Pipeline: FALCON-SegFormer Vision + XGBoost Geotechnical Package
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 p-5 rounded-2xl glass-card space-y-4">
          <div className="flex items-center justify-between border-b border-black/[0.06] pb-2.5">
            <div>
              ...
              <p className="text-xs font-mono text-text-muted">
                Test geotechnical hazard scenarios and weight distribution in real-time
              </p>
            </div>
            ...
            <div className="p-3 rounded-xl bg-black/[0.02] border border-black/[0.04] space-y-1.5">
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-text-primary font-bold">1. Visual AI Confidence (SegFormer)</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="text-text-muted text-[10px]">Weight: 35%</span>
            ...
            <div className="p-3 rounded-xl bg-black/[0.02] border border-black/[0.04] space-y-1.5">
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-text-primary font-bold">2. Ground Movement (Extensometer)</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="text-text-muted text-[10px]">Weight: 30%</span>
            ...
            <div className="p-3 rounded-xl bg-black/[0.02] border border-black/[0.04] space-y-1.5">
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-text-primary font-bold">3. Rainfall Accumulation</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="text-text-muted text-[10px]">Weight: 15%</span>
            ...
            <div className="p-3 rounded-xl bg-black/[0.02] border border-black/[0.04] space-y-1.5">
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-text-primary font-bold">4. Soil Moisture Content</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="text-text-muted text-[10px]">Weight: 10%</span>
            ...
            <div className="p-3 rounded-xl bg-black/[0.02] border border-black/[0.04] space-y-1.5">
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-text-primary font-bold">5. Pore Water Pressure</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="text-text-muted text-[10px]">Weight: 10%</span>
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="p-5 rounded-2xl glass-card space-y-4">
            ...
            <RiskFusion
              ...
              numericalScorePercent={Math.round((simMovement / 15) * 50 + (simRain / 60) * 30 + (simSoil / 100) * 20)}
          ...
          <div className="p-4 rounded-xl glass-card space-y-2.5 font-mono text-xs">
            <div className="flex items-center space-x-2 text-text-primary font-bold">
              ...
              <span className="uppercase font-display">Mathematical Fusion Formula</span>
            </div>

            <p className="text-[11px] text-text-secondary leading-relaxed">
              FALCON fuses optical image segmentation with in-situ numerical geotechnical telemetry:
            </p>

            <div className="p-2.5 rounded-lg bg-black/[0.03] border border-black/[0.05] text-[11px] text-[#E85D22]">
              Risk = 0.35·(AI) + 0.30·(Move) + 0.15·(Rain) + 0.10·(Soil) + 0.10·(Pore)
            </div>
          </div>
        </div>
      </div>
